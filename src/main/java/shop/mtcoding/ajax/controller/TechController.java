...
public class TechController {
    ...
    public @ResponseBody TechResponse.MainDTO techV1() {
        ...
        System.out.println("=================================");
        TechResponse.MainDTO mainDTO = new TechResponse.MainDTO(categoryList,
                techList);
    ...
    // // List<Category> catrgoryList = categoryRepository.findAll();
    // List<Tech> techList = techRepository.findByCategoryId(1);
    // System.out.println("==================================");
    // return techList; // messageconverter 발동 -json변환
    // }
